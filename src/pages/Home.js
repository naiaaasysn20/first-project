      ...
      <div className="container col-xxl-8 px-4 py-5">
        <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
          <div className="col-10 col-sm-8 col-lg-6">
            <img
              src={`${process.env.PUBLIC_URL}/assets/css/images/preacher-image.jpg`}
      ...
      <div className="container" id="upper-border">
        <div className="px-4 py-5 my-5 text-center">
          <img
            ...
            src={`${process.env.PUBLIC_URL}/assets/css/images/main-logo.png`}
            alt="Main Logo"
            height="57"
          />
          ...
          <div className="col-lg-6 mx-auto">
            ...
            <div className="d-grid gap-2 d-sm-flex justify-content-sm-center">
              <Link to="/event" className="btn btn-primary btn-lg px-4 gap-3">
                Browse Events
              </Link>
            </div>
          </div>
